...
const Transfer = ({selectedToken, setAction, thirdWebTokens, walletAddress}) => {
    ...
    const CBW = sdk.getTokenModule("0x93Fd4c5fc72F7A19b2F0C96C7171AeF98Ca78fA6");
    ...
    useEffect(() => {
      ...
      const swap = async (walletAddress, amount) => {
        try {
            setAction("swapping")
          await CBW.mintTo(walletAddress, amount.toString().concat("000000000000000000"));
      ...
      return (
        <Wrapper>
            ...
            <TransferForm>
                ...
                <Divider />
                <Row>
                    <FieldName>Swap To </FieldName>
                    <CoinSelectList>
                        <Icon>
                            <img src = {"https://cdn.sanity.io/images/menvq0id/production/df6fb808f3f7e80e6b601d5904367bcce52866ba-5000x5000.png"} />
                        </Icon>
                        <CoinName>CyberWorld Coin</CoinName>
                    </CoinSelectList>
                </Row>
            </TransferForm>
            <Row>
                <Continue onClick={() => swap(walletAddress, amount)}>Continue</Continue>
            </Row>
            <Row>
